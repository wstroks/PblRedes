 ...
 */
package br.ecomp.uefs.tela;

import br.ecomp.uefs.cliente.ClienteThread;
import br.ecomp.uefs.cliente.Jogador;
...
public class TelaJogo extends javax.swing.JFrame {
    ...
    public TelaJogo(ClienteThread con) {
    ...
    public void iniciar(){
        ...
        try {
            c.enviar.writeUTF("p1");
            palavraAtual  = c.entrada.readUTF();
    ...
    */
    ...
    Passa de Rodada
    */
    private void nextLvl() throws IOException{
        letras.setText(" ");
        ...
        if(lvl==4){
            String inputValue = JOptionPane.showInputDialog("Digite Seu nome");
            String []pontuacoes = {"1.","2.","3."};
            String entrada;
            int cont = 0;
            c.enviar.writeUTF("final");
        ...
        reiniciar();
        try {
            c.enviar.writeUTF("p"+lvl);
            System.out.println("p"+lvl);
            palavraAtual  = c.entrada.readUTF();
            dica.setText(c.entrada.readUTF());
        } catch (IOException ex) {
            Logger.getLogger(TelaJogo.class.getName()).log(Level.SEVERE, null, ex);
        }
